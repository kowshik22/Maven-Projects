		...
		<div class="container">	
			<div class="w3ls_about_grids">
				...
				<div class="col-md-6 w3ls_about_grid_right">
					<img src="Resource/images2/77.jpg" alt=" " class="img-responsive" />
				</div>
				<div class="clearfix"> </div>
			</div>
		</div>
		...
		<div class="container">
			...
			<div class="wthree_team_grids">
				<div class="col-md-3 wthree_team_grid">
					<img src="Resource/images2/8.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="Resource/images2/9.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="Resource/images2/10.png" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 wthree_team_grid">
					<img src="Resource/images2/11.png" alt=" " class="img-responsive" />
